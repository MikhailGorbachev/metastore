...
public class MemoryMetaStore extends BaseMetaStore implements IMetaStore {
  ...
  private ConcurrentMap<String, MemoryMetaStoreNamespace> namespacesMap =
      new ConcurrentHashMap<String, MemoryMetaStoreNamespace>();
  ...
  public List<String> getNamespaces() throws MetaStoreException {
    ...
    try {
      namespaces = new ArrayList<String>( namespacesMap.keySet() );
      return namespaces;
    } finally {
      readLock.unlock();
    }
